...
const questions = [
    ...
    "Если бы мы вдруг оказались одни в пустом кинотеатре, что бы ты сделал(а)?",  
    ...
    "Если бы мы играли в 'Правда или действие' — что бы выбрал(а) прямо сейчас?",  
    "Какой вопрос ты боишься, чтобы я задала и почему?",  
